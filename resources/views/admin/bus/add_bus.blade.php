...
<div class="content-wrapper">
    <section class="content"><br>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.busadd') }}" id="insertform">
                        @csrf
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning" data-dismiss="modal"><a href="{{ route('admin.showbus') }}">Back</a></button>
